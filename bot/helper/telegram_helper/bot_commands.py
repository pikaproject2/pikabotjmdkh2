...
class _BotCommands:
    def __init__(self):
        ...
        self.ZipMirrorCommand = [f'zipmirror2{CMD_SUFFIX}', f'zm2{CMD_SUFFIX}']
        ...
        self.PingCommand = ['ping2', 'p']
        self.RestartCommand = [f'restart2{CMD_SUFFIX}', 'restartall']
        ...
        self.CategorySelect = f'catsel2{CMD_SUFFIX}'
        self.RmdbCommand = f'rmdb2{CMD_SUFFIX}'
